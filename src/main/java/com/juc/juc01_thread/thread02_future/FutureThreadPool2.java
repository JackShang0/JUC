...
public class FutureThreadPool2 {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        FutureTask<String> stringFutureTask1 = new FutureTask<>(myThreadCallable);
         ...
         *
         *         System.out.println(stringFutureTask.GetApi());
         *
         ...
         */
        //System.out.println(stringFutureTask.GetApi());
        //System.out.println(stringFutureTask.GetApi(3,TimeUnit.SECONDS));       //-->设置等待时间
